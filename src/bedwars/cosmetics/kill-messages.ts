/**
 * Bed Wars kill message cosmetics.
 *
 * Each kill message defines its display name, rarity, acquisition cost, and the
 * set of message lines it produces (kill variants plus the bed-break line).
 * Placeholder tokens (<player1>, <player2>, <Color>, <#>) are preserved verbatim.
 */
...
export const BEDWARS_KILL_MESSAGES: readonly BedWarsKillMessage[] = [
  {
    name: "Fire",
    rarity: "COMMON",
    cost: 5000,
